		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Depot Portal",
									"targetURL": "#zdepotportal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zdepotportal-display": {
								"semanticObject": "zdepotportal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zdepotportal",
									"url": sap.ui.require.toUrl("zdepotportal")
								}
							}
						}
					}

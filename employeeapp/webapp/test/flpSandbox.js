		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee",
									"targetURL": "#comemployeeappemployeeemployeeapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comemployeeappemployeeemployeeapp-display": {
								"semanticObject": "comemployeeappemployeeemployeeapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.employeeapp.employee.employeeapp",
									"url": sap.ui.require.toUrl("com/employeeapp/employee/employeeapp")
								}
							}
						}
					}
